...
remiander_2 = remainder_5 % 2

amount_1 = remainder_2

print(" The minimum change needed is {0} £20 notes, {1} £10 notes, {2} £5 notes, {3} £2 coins, {4} £1 coins".format(amount_20, amount_10, amount_5, amount_2, amount1))
